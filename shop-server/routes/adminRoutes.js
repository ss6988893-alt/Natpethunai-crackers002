...
import { login, logout, me, updateCredentials } from '../controllers/authController.js';
...
router.post('/auth/login', loginLimit, login); router.post('/auth/logout', logout); router.get('/auth/me', requireAdmin, me); router.put('/auth/credentials', requireAdmin, updateCredentials);
