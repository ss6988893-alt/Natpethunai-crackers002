...
const requiredInProduction = ['MONGODB_URI', 'FRONTEND_URL', 'JWT_SECRET'];
...
export const env = {
  ...
  jwtSecret: process.env.JWT_SECRET || (process.env.NODE_ENV === 'production' ? undefined : 'development-only-change-this-secret'),
  jwtExpiresIn: process.env.JWT_EXPIRES_IN || '8h',
  jwtCookieSeconds: Number(process.env.JWT_COOKIE_SECONDS || 28800),
  shop: {
