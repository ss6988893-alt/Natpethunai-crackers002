...
export default function FloatingActions() {
  ...
  return <div className="floating-actions" aria-label="Quick actions">
    <motion.a className="float-button float-button--whatsapp" href={`https://wa.me/${ownerPhone}?text=${message}`} target="_blank" rel="noreferrer" aria-label="Chat with Natpe Thunai Crackers on WhatsApp" whileHover={{ scale: 1.08 }} whileTap={{ scale: .94 }}><FaWhatsapp aria-hidden="true" /><span><small>Chat with us</small>WhatsApp</span></motion.a>
